...
declare namespace UnionKey {
   ...
   *
   * - Use the default gray background: defaultType: 'default'
   * - Using fixed custom picture: gman.defaulttype: 'custom' customImageUrl: 'https://example.com/background.jpg'
   * - Use gradient backgrounds: defaultType: 'gradient', gradientColors: {from: '#667eea', to: '#764ba2'}
   */
  type BackgroundConfigModule = 'default' | 'custom' | 'gradient';
